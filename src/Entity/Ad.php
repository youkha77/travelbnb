 ...
 * @UniqueEntity(
 *  fields={"title"},
 * message="Une autre annonce possède déja ce titre, merci de la modifier"
 * )
 */
class Ad
{
    ...
    /**
     * @ORM\Column(type="text")
     * @Assert\Length(min=100, minMessage="Votre introduction doit faire moins de 100 caractères")
     */
    private $content;
    ...
    /**
     * Peermet de récupérer le commentaire d'un auteur par rapport à une annonce
     *
     * @param User $author
     * @return Comment|null
     */
     ...
     *
     * @return array Un tableau d'objets DateTime représantant les jours d'occupation
     */
